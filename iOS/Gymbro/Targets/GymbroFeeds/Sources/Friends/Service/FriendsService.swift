...
final class FeedsPeopleServiceImpl: FeedsPeopleService {
    ...
    func fetchScreen(input: PeopleScreenInput) async throws -> FeedsPeopleScreenData {
        ...
        case .mine:
            ...
            async let followersResponse = client.fetchFollowers()
            ...
            let followers = try await followersResponse.map(PersonItem.init(response:))
            ...
            return FeedsPeopleScreenData(
                ...
                followers: followers.filter { !friendIDs.contains($0.id) },
        ...
        case .user(let userID, _):
            ...
            async let followersResponse = client.fetchFollowersByUser(userID: String(userID))
